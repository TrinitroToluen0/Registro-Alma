...
if(isset($_POST['register_validation']))
{
    ...
    else
    {
        ...
        else
        {
            ...
            $request = $login_db->prepare('INSERT INTO accounts (Id, Login, PasswordHash, Nickname, Email, SecretQuestion,  SecretAnswer, CreationDate, Lang, Role, IsBanned, SubscriptionEnd) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)');
            ...
            echo '<p class="alert valid"><span class="ico_check"></span> Te has registrado satisfactoriamente, bienvenido a Dofus Alma!</p>';
        }
    }
}
?>